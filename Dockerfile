...
RUN CGO_ENABLED=1 go build \
  -ldflags "-X github.com/sandrorichi/webapp-template/internal/version.Version=${VERSION} -X github.com/sandrorichi/webapp-template/internal/version.Commit=${COMMIT} -X github.com/sandrorichi/webapp-template/internal/version.BuildTime=${BUILDTIME}" \
  -o /bin/app ./cmd/app
