...
def main() -> int:
    ...
    ldflags = (
        f"-X github.com/sr1ch1/webapp-template/internal/version.Version={version} "
        f"-X github.com/sr1ch1/webapp-template/internal/version.Commit={commit} "
        f"-X github.com/sr1ch1/webapp-template/internal/version.BuildTime={build_time}"
    )
